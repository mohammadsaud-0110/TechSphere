  ...
  return (
    <nav className="flex justify-evenly py-5 items-center">
      ...
      <div className="flex gap-5 items-center">
        ...
        <a
          href="#_"
          className="relative items-center justify-start inline-block px-5 py-3 overflow-hidden font-medium transition-all bg-blue-600 rounded-lg hover:bg-white group h-12"
        >
